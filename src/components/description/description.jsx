  ...
  return (
    <div className={classes.about}>
      ...
      <div className={classes.misc}>
        ...
        {type === "movie" ? (
          <h4 className={classes.duration}>{get_duration(data.runtime)}</h4>
        ) : null}
      </div>
      ...
      <div className={classes.ratings}>
        <h4 className={classes.ratingNumber}>
          {get_movie_popularity(data.vote_average)}%
        </h4>
      ...
      <div className={classes.info}>
        ...
        <h4 className={classes.description}>
          {data.overview || `We have no information about this ${type}`}
        </h4>
      </div>
      {data.director === undefined &&
      data.actors === undefined &&
      data.writer === undefined ? null : (
