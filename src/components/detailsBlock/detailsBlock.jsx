          ...
          <div className={classes.socials}>
            {content.external_ids.facebook_id ? (
              <Facebook
                ...
                id={content.external_ids.facebook_id}
              />
            ) : null}
            {content.external_ids.twitter_id ? (
              <Twitter
                className={classes.social}
                id={content.external_ids.twitter_id}
              />
            ) : null}
            {content.external_ids.instagram_id ? (
              <Instagram
                className={classes.social}
                id={content.external_ids.instagram_id}
              />
            ) : null}
            {content.homepage ? (
              <Homepage className={classes.social} link={content.homepage} />
            ) : null}

            {type === "person" ? null : (
              <JustWatch
                className={classes.social}
                link={get_just_watch_query(
            ...
            {content.external_ids.imdb_id ? (
              <Imdb
                className={classes.social}
                id={content.external_ids.imdb_id}
                type={type}
              />
            ) : null}
          </div>
