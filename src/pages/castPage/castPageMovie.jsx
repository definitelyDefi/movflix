...
export const CastPageMovie = () => {
  ...
  let headerImage = useSelector((state) => state.movies.currentMovie.poster_path);
  ...
  return (
    <div className={classes.container}>
      {isFetching ? (
        ...
        <>
          <SmallHeader headerImage={headerImage} title={title} date={date} text={"Back to movie"} padding={"250"} />

          <div className={classes.items}>
            <div className={classes.castBlock}>
              <h1 className={classes.castHeader}>
                The cast of the movie <span className={classes.grayText}>{full_credits.cast.length}</span>
              </h1>
                  ...
                  <div className={classes.castItem}>
                    ...
                    <div className={classes.castInfo}>
                      ...
                      <ul className={classes.roles}>
                        {person.character ? <li className={classes.role}>{person.character}</li> : null}
                      </ul>
                    </div>
                  </div>
                ))}
                  ...
                  <div className={classes.castItem}>
                    ...
                    <div className={classes.castInfo}>
                      ...
                      <ul className={classes.jobs}>
                        {person.job ? <li className={classes.role}>{person.job}</li> : null}
                      </ul>
                    </div>
                  </div>
                ))}
